  ...
  function ScrollSmoother(e) {
    ...
    function oa(e, t) {
      ((e !== g && !l) || t) &&
        ...
        (w = e - g),
        (g = e),
        F.isUpdating || F.update());
    }
    function pa(e) {
      return arguments.length
        ? (l && (g = -e), (x.y = -e), (u = !0), h(e), this)
        : -g;
    }
    function ra(e) {
      (v.scrollTop = 0),
        F.isInViewport(e.target) ||
          e.target === f ||
        ...
        (r = t.pins),
          ...
          e.forEach(function (e) {
            (e.trigger !== t.trigger && e.pinnedContainer !== t.trigger) ||
              ...
              e.markerStart &&
                i.push(P.quickSetter([e.markerStart, e.markerEnd], "y", "px")),
              e.pin &&
                0 < e.end &&
                ((o = e.end - e.start),
      ...
      la(),
        ...
        b &&
          (b.forEach(function (e) {
            var t = e.start,
              r = e.auto
                ? Math.min(F.maxScroll(e.scroller), e.end)
                : t + (e.end - t) / e.ratio,
              n = (r - e.end) / 2;
            (t -= n),
              (r -= n),
          ...
          var t = (function _autoDistance(e, t) {
            ...
            return (
              0 < c &&
                ((u +=
                  -(n =
                    0.5 == (r = a.height / (R.innerHeight + a.height))
                      ? 2 * a.height
                      : 2 * Math.min(a.height, (-c * r) / (2 * r - 1))) / 2),
                (c += n)),
              { change: c, offset: u }
            );
                ...
                if (e.offset) {
                  if (i) {
                    for (r = -x.y, n = e.end; i--; ) {
                      if (
                        ...
                        return void (
                          ...
                          t.trig.update(0, 0, 1),
                          l.resetTo("y", parseFloat(d.y), -w, !0),
                          S && l.progress(1))
                        );
                    ...
                    o =
                      ...
                      a +
                      m *
                        ((P.utils.clamp(e.start, e.end, r) - e.start - a) /
                          (n - e.start) -
                          c);
                  }
                  (o = (function _round(e) {
                    ...
                    l
                      ? (l.resetTo("y", o, -w, !0), S && l.progress(1))
    ...
    F.addEventListener("refresh", ta),
      ...
      (this.scrollTo = function (e, t, r) {
        ...
        t
          ? l
            ? P.to(o, { duration: d, scrollTop: n, overwrite: "auto", ease: I })
            : h(n)
          : pa(n);
      }),
      ...
      (this.content = function (e) {
        return arguments.length
          ? ((r = M(e || "#smooth-content")[0] || H.children[0]),
            (s = r.getAttribute("style") || ""),
            P.set(r, { overflow: "visible", width: "100%" }),
            this)
          : r;
      }),
    ...
    E.forEach(function (e) {
          ...
          ? (!!l !== e &&
              (e
                ...
                : (l.kill(),
                  (l = 0),
                  c && c.enable(),
                  (n.progress = (-g - n.start) / (n.end - n.start)),
                  na(n))),
            this)
          : !!l;
      }),
      (this.kill = function () {
        ...
        F.scrollerProxy(v),
          F.removeEventListener("refresh", ta),
          (v.style.cssText = a),
          (r.style.cssText = s);
        var t = F.defaults({});
        t && t.scroller === v && F.defaults({ scroller: R }),
          o.observer && F.normalizeScroll(!1),
          clearInterval(i),
          (B = null),
          R.removeEventListener("focusin", ra);
      }),
      e.normalizeScroll &&
        (this.observer = F.normalizeScroll({ debounce: !0 })),
      F.config(e),
      "overscrollBehavior" in R.getComputedStyle(H) &&
        P.set(H, { overscrollBehavior: "none" }),
